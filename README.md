...
[<img src="https://img.shields.io/badge/Download-Latest_Release-003171?style=for-the-badge&logo=android&logoColor=white" height="45">](https://github.com/Ixeken-Studios/gakuu-app/releases/latest)
...
- **Matrix Digital Rain**: Falling green and custom glyph cascades with randomized speed and glyph mutations.
...
- **6 Curated Theme Palettes**: Ixeken Light, Ixeken Dark, Cherry, Earthy, Amoled (Pure Pitch Black), and Elegance.
...
- **Google Fonts Integration**: Support for Outfit (GS Flex), Inter, Rubik, Geomini, Ubuntu, Nunito, and System Default typography.
...
Create a new Kotlin class inside `android/app/src/main/kotlin/com/ixeken/gakuu/engines/`:
...
1. **Clone Repository**:
   ```bash
   git clone https://github.com/Ixeken-Studios/gakuu-app.git
   cd gakuu-app
   ```
